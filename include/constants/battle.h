...
#define VOLATILE_DEFINITIONS(F) \
    ...
    F(VOLATILE_INFINITY_COCOON,             infinityCocoon,                (u32, 1)) \
...
#define B_WEATHER_SHADOW_SKY    (1 << BATTLE_WEATHER_SHADOW_SKY)

#define B_WEATHER_DAMAGING_ANY  (B_WEATHER_HAIL | B_WEATHER_SANDSTORM | B_WEATHER_SHADOW_SKY)
...
#define B_WEATHER_ANY           (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_ICY_ANY | B_WEATHER_STRONG_WINDS | B_WEATHER_FOG| B_WEATHER_SHADOW_SKY)
