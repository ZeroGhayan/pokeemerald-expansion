...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_SHADOWSKYSTARTED]                     = COMPOUND_STRING("A shadowy aura began to rage!"),
    [STRINGID_SHADOWSKYCONTINUES]                   = COMPOUND_STRING("Bursts of light showered from the shadowy aura!"),
    [STRINGID_SHADOWSKYSUBSIDED]                    = COMPOUND_STRING("The shadowy aura faded away."),
    [STRINGID_PKMNHURTBYSHADOWSKY]                  = COMPOUND_STRING("The flashing light strikes {B_DEF_NAME}!"),
