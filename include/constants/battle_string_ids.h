...
enum StringID
{
    ...
    STRINGID_SHADOWSKYSTARTED,
    STRINGID_SHADOWSKYCONTINUES,
    STRINGID_SHADOWSKYSUBSIDED,
    STRINGID_PKMNHURTBYSHADOWSKY,
    STRINGID_COUNT
};
